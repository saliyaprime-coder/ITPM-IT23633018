...
python test\_automation.py --excel "Assignment 1 - Test cases.xlsx" --header-row 1 --url "https://www.pixelssuite.com/chat-translator" --wait-ms 8000 --type-delay-ms 100 --slow-mo-ms 500 --save-every 1
